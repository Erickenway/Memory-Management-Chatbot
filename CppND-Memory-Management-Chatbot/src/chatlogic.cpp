...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    // add nguoimay to graph root node
    ChatBot nguoimay("../images/chatbot.png");
    nguoimay.SetChatLogicHandle(this);
    nguoimay.SetRootNode(rootNode);
    rootNode->MoveChatbotHere(std::move(nguoimay)); 
}
